...
const NewProject = () => {
    ...
    const handleSave = () => {
        ...
        addProject({ title: enteredTitle, description: enteredDescription, dueDate: enteredDueDate })
    }
        ...
        <>
            ...
            <div className="w-[35rem] mt-16">
                <menu className="flex items-center justify-end gap-4 my-4">
                    <li><button onClick={cancelAddProject} className="text-stone-800 hover:text-stone-950">Cancel</button></li>
